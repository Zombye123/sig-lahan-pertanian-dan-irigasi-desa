...
class Home extends CI_Controller
{
    ...
    // FUNGSI BARU UNTUK FILTER KONDISI
		public function irigasi_by_kondisi($kondisi_url)
		{
			// Ubah kembali '-' menjadi spasi (misal: "Rusak-Ringan" jadi "Rusak Ringan")
			$kondisi = str_replace('-', ' ', $kondisi_url);
			
			$data = array(
				'title'   => 'Data Irigasi Kondisi: ' . $kondisi,
				'irigasi' => $this->m_irigasi->get_by_kondisi($kondisi),
				'isi'     => 'irigasi/v_data' 
			);
			$this->load->view('layout/v_wrapper', $data, FALSE);
		}
